...
public class SoapConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(
        ...
        return new ServletRegistrationBean<>(servlet, "/common-1-2/*");
    }
    ...
    @Bean(name = "ICON2.Source.Authorization.ws.provider:AuthAuth")
    public Wsdl11Definition authWSDL() {
        SimpleWsdl11Definition wsdl11Definition = new SimpleWsdl11Definition();
        wsdl11Definition.setWsdl(new ClassPathResource("wsdl/AuthAuth.wsdl"));
