...
import ca.bc.gov.open.icon.bcs.DestroyCredential;
import ca.bc.gov.open.icon.bcs.DestroyCredentialResponse;
import ca.bc.gov.open.icon.bcs.DestroyCredentialResponse2;
...
class IconConsumerApplicationTests {
    ...
    void testProcessHSR() throws JsonProcessingException, InterruptedException {
        ...
        when(soapTemplate.marshalSendAndReceive(anyString(), Mockito.any(SubmitHealthServiceRequest.class)))
                .thenReturn(soapResp);
