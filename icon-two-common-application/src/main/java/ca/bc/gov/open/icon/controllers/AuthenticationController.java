...
public class AuthenticationController {
  ...
  public ReauthenticationSucceededResponse reauthenticationSucceeded(
    ...
    Reauthentication inner =
        reauthenticationSucceeded != null && reauthenticationSucceeded.getReauthentication() != null
  ...
  public LogoutExcecutedResponse logoutExecuted(@RequestPayload LogoutExcecuted logoutExecuted)
    ...
    UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(host + "auth/logout-executed");
    Logout inner =
    ...
    try {
      ...
      log.error(
          objectMapper.writeValueAsString(
              new OrdsErrorLog(
                  "Error received from ORDS", "logoutExecuted", ex.getMessage(), logoutExecuted)));
      throw new ORDSException();
    }
  }
  ...
  public IdleTimeoutExecutedResponse idleTimeoutExecuted(
      @RequestPayload IdleTimeoutExecuted idleTimeoutExecuted) throws JsonProcessingException {
  ...
  public GetPreAuthorizeClientResponse getPreAuthorizeClient(
      @RequestPayload GetPreAuthorizeClient getPreAuthorizeClient) throws JsonProcessingException {
    ...
    try {
      HttpEntity<GetPreAuthorizeClientResponse> resp =
          restTemplate.exchange(
              builder.toUriString(), HttpMethod.GET, payload, GetPreAuthorizeClientResponse.class);
      log.info(
          objectMapper.writeValueAsString(
