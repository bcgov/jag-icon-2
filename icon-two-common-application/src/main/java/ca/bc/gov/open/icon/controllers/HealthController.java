...
public class HealthController {
    ...
    public HealthServiceRequestSubmittedResponse healthServiceRequestSubmitted (
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(host + "health/health-service-rqst-submitted");
        HttpEntity<HealthServiceRequest> payload = new HttpEntity<>( healthServiceRequestSubmitted, new HttpHeaders());
    ...
    public GetHealthServiceRequestHistoryResponse getHealthServiceRequestHistory (
        ...
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(host + "health/health-service-rqst-history");
        HttpEntity<GetHealthServiceRequestHistory> payload = new HttpEntity<>( getHealthServiceRequestHistory, new HttpHeaders());
    ...
    public PublishHSRResponse publishHSR (
            @RequestPayload PublishHSR publishHSR
    )
            throws JsonProcessingException {
    ...
    public GetHSRCountResponse getHSRCount (
            @RequestPayload GetHSRCount getHSRCount
    )
            throws JsonProcessingException {

        UriComponentsBuilder builder =
                UriComponentsBuilder.fromHttpUrl(host + "health/get-hsr-count");
